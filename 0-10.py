...
def play_game():
    num1 = random.randint(0, 10) # Coloque nos parênteses o intervalo de números para o primeiro jogador
    num2 = random.randint(0, 10) # Coloque nos parênteses o intervalo de números para o segundo jogador
    total_sum = num1 + num2
