...
# Função que gera 2 números aleatórios entre 0 e 10, soma os dois e verifica se é par ou ímpar
def play_game():
    num1 = random.randint(1, 10) # Coloque nos parênteses o intervalo de números para o primeiro jogador
    num2 = random.randint(1, 10) # Coloque nos parênteses o intervalo de números para o segundo jogador
    total_sum = num1 + num2
